...
global {
	...
	shape_file rooms_shape_file <- shape_file("../transformed/rooms.shp");
	shape_file entrances_shape_file <- shape_file("../transformed/entrances.shp");
	shape_file walls_shape_file <- shape_file("../transformed/walls.shp");
	shape_file pedestrian_path_shape_file <- shape_file("../generated2/pedestrian_paths.shp");
	shape_file free_spaces_shape_file <- shape_file("../generated2/free_spaces.shp");
	shape_file open_area_shape_file <- shape_file("../generated2/open_area.shp");
