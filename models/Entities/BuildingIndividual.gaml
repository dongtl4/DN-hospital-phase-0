...
import "../../COMOKIT-Model/Model/Entities/Individual.gaml"
...
//		}
 	...
 	aspect default {
		if(!is_outside){
			draw pple_walk size: people_size  at: location + {0, 0, 0.3} rotate: heading - 90 color: color;
			if(is_infected){draw circle(0.2)  at: location + {0, 0, 0.3} color: get_color();}
		}
	}
}
